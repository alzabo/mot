...
//go:generate gojsonstruct --abbreviations TMM,DL,ETA,NB --int-type int64 --package-name torrent --package-comment "DO NOT EDIT" --typename Tracker --o tracker.go data/tracker.json
